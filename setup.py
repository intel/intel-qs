...
class CMakeBuild(build_ext):
    ...
    def build_extension(self, ext):
        ...
        subprocess.check_call(['cmake3', '--build', '.', '--target', 'python'] + build_args, cwd=self.build_temp)

setup(
    name=project_name,
    version=_VERSION,
    author='Fabio Baruffa',
    author_email='fabio.baruffa@intel.com',
    url='https://github.com/iqusoft/intel-qs',
    description='Quantum High Performance Software Testing Environment',
    long_description='',
    python_requires=('>=3.6.0'),
    packages=find_packages('src'),
    include_package_data=True,
    ext_modules=[CMakeExtension('intelqs_py')],
